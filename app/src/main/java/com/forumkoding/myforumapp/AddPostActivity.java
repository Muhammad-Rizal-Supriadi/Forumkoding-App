...
public class AddPostActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //get some info or current user to include in post
        ...
        uploadBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                //get data(title, description) fron edittext
    ...
    private boolean checkStoragePermission(){
        //check if storage permisstion is enabled or not
    ...
    private boolean checkCameraPermission(){
        //check if camera permisstion is enabled or not
        //return true if enabled
        //return false if not enabled
        boolean result = ContextCompat.checkSelfPermission(this,
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        //this method id called when user press allow or deny from permission request dialog
